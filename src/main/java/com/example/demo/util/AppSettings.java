...
public class AppSettings {
	...
	public static final String ACTIVOR = "verificado";
	public static final String INACTIVOR = "pendiente";
	
	public static final String ACTIVOM = "vacio";
	public static final String INACTIVOM = "ocupado";
